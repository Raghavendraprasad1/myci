    ...
    <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
      <div class="card card-signin my-5">
        <div class="card-body">
          ...
          <?php endif; ?>
          <?php echo form_open("admin/home/verify_email", "class='my_form' id='my_form' "); ?>
          <div class="form-signin">
            <div class="form-label-group">
              <input type="text" id="vEmail" name="vEmail" class="form-control" placeholder="Enter email">
              <!-- <label for="vEmail">Enter Email</label> -->
            </div>

            <div class="form-label-group">
              <input type="text" id="vPassword" name="vPassword" class="form-control" placeholder="Password">
