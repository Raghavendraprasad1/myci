      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <?php endif; ?>
            <?php echo form_open("admin/home/sent_otp","class='my_form' id='my_form' "); ?>
            <form class="form-signin">
              <div class="form-label-group">
                <input type="text" id="mobileno" name="mobileno" class="form-control" placeholder="Mobile Number" autofocus>
